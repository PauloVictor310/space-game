...
//
// DescriÁ„o:   A classe abstrai todos os detalhes de configuraÁ„o de
...
// -------------------------------------------------------------------------------
// InicializaÁ„o de membros est·ticos da classe
bool Window::windowKeys[256] = { 0 };                       // estado do teclado/mouse
int  Window::windowMouseX = 0;                              // posiÁ„o do mouse no eixo x
int  Window::windowMouseY = 0;                              // posiÁ„o do mouse no eixo y
...
Window::Window()
{
    hInstance       = GetModuleHandle(NULL);                // identificador da aplicaÁ„o
...
{ 
    ...
    // calcula a posiÁ„o do centro da janela
    windowCenterX = windowWidth / 2.0f;
    windowCenterY = windowHeight / 2.0f;

    // ajusta a posiÁ„o da janela para o centro da tela
...
bool Window::Create()
{
    ...
    if (windowMode == WINDOWED)
    {
        ...
        MoveWindow(
            ...
            windowPosX,                    // posiÁ„o x
            windowPosY,                    // posiÁ„o y
            winRect.right - winRect.left,  // largura
            winRect.bottom - winRect.top,  // altura
            TRUE);                         // repintar
    }

    // retorna estado da inicializaÁ„o (bem sucedida ou n„o)
